...
<div class="bg-no-repeat bg-cover bg-center relative"
    style="background-image: url(https://images.unsplash.com/photo-1529798856831-427dfd0a1ab1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80);">
                ...
                <div class="space-y-5">
                    <div class="space-y-2">
                        ...
                        <input
                            ...
                            name="email" type="email" placeholder="you@mfac.edu.au" <?php if (isset($_POST['email'])) { echo "value='". $_POST["email"] . "'"; } else { }?>>
                    </div>
                    <div class="space-y-2">
