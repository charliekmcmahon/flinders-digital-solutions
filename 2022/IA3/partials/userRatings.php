...
<div class="row-span-1 <?php if ($json["totalSeasons"] >= '0') { echo 'col-span-2'; } else {echo 'col-span-3' ;} ?>">
    <div class="">
        <div class="block p-6 mr-0 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div class="flex w-full p-0 m-0 align-middle self-center">
                    <div class="flex-1 self-center">
                        <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><span class="underline decoration-yellow-400 decoration-[0.25rem] motion-safe:transition-all motion-safe:duration-200 hover:decoration-yellow-600">User Ratings</span></h5>
                    </div>
                    <div class="flex-1 self-center">
    ...
    <div class="relative p-4 w-full max-w-7xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                ...
                $sql = "SELECT reviews.*, users.userID, users.profileImage, users.username, users.email, users.SignUpDate, (SELECT AVG(reviews.rating) FROM reviews WHERE reviews.movieID = '$movieID') AS avgRating, (SELECT COUNT(reviews.reviewID) FROM reviews WHERE reviews.username = users.username) AS numReviews FROM reviews INNER JOIN users ON reviews.username=users.username WHERE reviews.movieID = '$movieID'";
