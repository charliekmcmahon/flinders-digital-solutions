<div class="flex flex-col items-center bg-white rounded-l border shadow-md md:flex-row md:rounded-lg hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
