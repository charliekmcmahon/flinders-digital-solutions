...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
    ...
    $query = "UPDATE reports (AuthorNickname, LocationID, DamageDescription, DamagePicture) VALUES ('$userNick', '$location', '$damage', '$target_file') WHERE ReportID = " . $_POST["ReportID"];
