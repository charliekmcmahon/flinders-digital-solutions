...
if (isset($_GET["error"])) {
    ...
    if ($_GET["error"] == "userexists") {
        ...
        echo '<span class="block sm:inline">The nickname entered was invalid.</span>';
...
<head>
    <meta charset="UTF-8">
    <title>Sign up | Dog Parks & Beaches</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body>
    <?php require('../page-templates/semi-dynamic-pages/sign-up.php'); ?>
</body>
</html>