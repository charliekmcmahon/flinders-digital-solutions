...
if (isset($_POST["report"])) {
    ...
    $sql = "SELECT reports.*, users.*, (SELECT COUNT(reports.AuthorNickname) FROM reports WHERE reports.AuthorNickname = users.nickname) AS userTotalReports FROM reports INNER JOIN users ON reports.AuthorNickname=users.nickname WHERE reports.ReportID = " . $_POST["report"] . " LIMIT 1";
...
<div class="p-6 w-1/2 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="mb-6">
        <label for="nickname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">User's Nickname</label>
        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?php echo $authorNickname; ?>" required>
    </div>
    <div class="mb-6">
