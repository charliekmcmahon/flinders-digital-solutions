        ...
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"> View Map </a>
            </div>
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"> Submit a report </a>
            </div>
          </div>
        </div>
      </main>
...
<div class="lg:flex lg:items-center lg:justify-between">
  <div class="flex-1 min-w-0">
    ...
    <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
      ...
      <div class="mt-2 flex items-center text-sm text-gray-500">
        <!-- Heroicon name: solid/location-marker -->
        <img class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" src="assets/letter-b.png" alt="">
        Indicates a Beach Access
      </div>
      <div class="mt-2 flex items-center text-sm text-gray-500">
        <!-- Heroicon name: solid/location-marker -->
        <img class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" src="assets/letter-d.png" alt="">
