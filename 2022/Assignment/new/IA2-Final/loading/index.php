    ...
    if (empty($email) || empty($password)) {
        ...
        if ($result !== null) {
            ...
            if ($hashedPwdCheck == true) {
                ...
                require('../page-templates/static-pages/loading.php');
                echo "<script> window.setTimeout(function(){ window.location.href = '../dashboard'; }, (Math.floor( Math.random() * ( 5000 - 1000 + 1 )) + 1000)); </script>";
                exit();
            } else {
